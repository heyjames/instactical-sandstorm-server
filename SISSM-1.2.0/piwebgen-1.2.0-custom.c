...
//
#define STEAM_PROFILE "<a href=\"http://steamcommunity.com/profiles/76560000000000001/\" target=\"_blank\" class=\"player\">"
#define EPIC_PROFILE  "<a href=\"javascript:alert(\'01234567890123456789012345678901|01234567890123456789012345678901\');\" style=\"color: #8ebf42\" class=\"player2\">"
...
static int _genWebFile( void )
{
	...
	if ( 0 != piwebgenConfig.utf8Encoding ) {
        ...
        // Use custom styles
        fprintf( fpw, "<link rel=\"stylesheet\" href=\"styles.css\"> \n" );

        // Use custom scripts
        fprintf( fpw, "<script type=\"text/javascript\" src=\"script.js\"></script> \n" );
        ...
        if ( 0 != strlen( piwebgenConfig.directConnect ) )
            fprintf( fpw, "<br>Connect: <span id=\"ip\">%s</span> <span id=\"copy-btn\">Copy</span>\n", piwebgenConfig.directConnect );
